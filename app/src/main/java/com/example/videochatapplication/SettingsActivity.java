...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void saveUserData(){
        ...
        if (ImageUri == null){
            ...
            Toast.makeText(this, "User info is required.", Toast.LENGTH_SHORT).show();
        }else{
            progressDialog.setTitle("Account Settings");
            progressDialog.setMessage("Please wait...");
            progressDialog.show();

            final StorageReference filePath = userProfileImageRef.child(
    ...
    private void saveInfoOnlyWithoutImage() {
        ...
        if (getUserName.equals("")){
            ...
            progressDialog.setTitle("Account Settings");
            progressDialog.setMessage("Please wait while we update your settings...");
            progressDialog.show();
